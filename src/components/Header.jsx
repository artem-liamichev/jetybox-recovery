    ...
    <header className="relative z-[120] w-full min-w-[375px] border-white bg-[#333333_43%] px-4 md:absolute md:inset-x-0 md:top-0 md:bg-[#333333] md:px-0">
      <nav className="relative z-[120] flex items-center justify-between pt-3 md:m-auto md:h-[70px] md:max-w-[1170px] md:px-4 md:pt-0">
        <Listbox
          ...
          className="uppercase"
        >
          <div className="relative z-[130] h-9 w-16">
            <Listbox.Button className="selector-shadow flex w-full cursor-pointer rounded py-1.5 pl-2 text-left hover:bg-gray-400 hover:opacity-80 focus:outline-none">
              <div className="back flex h-full items-center justify-center gap-1.5 rounded bg-[#2e2e2e]">
                <span className="block truncate -mt-0.5 text-white uppercase">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute z-[140] mt-[10px] max-h-60 w-full overflow-auto rounded bg-[#454545] py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                {languages.map((language, languageIdx) => (
                  <div key={languageIdx} className="relative">
                    <Listbox.Option
                      className={({ active }) =>
                        `lang-button select-none py-[1.5px] ${active ? "bg-opacity-100" : "bg-transparent"
                        }`
                      }
                      value={language}
                    >
                      {({ selected: isSelected }) => (
                        <span
                          className={`block truncate ${isSelected ? "text-white" : "text-[#7D7D7D]"
                            }`}
                        >
                          {language}
                        </span>
        ...
        {isOpen && (
          ...
          >
            <button
              type="button"
              className="hover:opacity-80 self-end rounded-md py-3 focus:outline-none focus:ring-2 focus:ring-inset"
            ...
            <div className="mx-[-20px] h-[0.5px] border border-white border-opacity-60"></div>

            <section className="mt-6 flex flex-col items-start text-left">
              <h3 className="font-[Plateia] text-2xl font-normal uppercase leading-9">
                {t("Solutions")}
              </h3>
              ...
              <p className="mb-5 mt-[152px]">
                <a href="tel:+79836315539">+7 (983) 631-55-39</a>
              </p>
            </section>
            ...
            <section>
              <div className="my-5 flex flex-row gap-[10px]">
                <button className="social-button flex h-[26px] w-[26px] items-center justify-center rounded rounded-s bg-[#1C1C1C]">
                  <a
                    ...
                    >
                      <defs>
                        <linearGradient
                          ...
                          y2="100%"
                        >
                          <stop offset="0%" stopColor="#D69B56"></stop>
                          <stop offset="100%" stopColor="#FDDFBC"></stop>
                        </linearGradient>
                      </defs>
                      <path
